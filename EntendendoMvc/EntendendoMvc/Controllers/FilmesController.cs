...
namespace EntendendoMvc.Controllers
{
    ...
    {
        private readonly EntendendoMvcContext _context;

        public FilmesController(EntendendoMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EntendendoMvcContext.Filme'  is null.");
            }
            var filme = await _context.Filme.FindAsync(id);
            if (filme != null)
            {
